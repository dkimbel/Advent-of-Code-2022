...
fn main() {
    ...
    let mut longer_simulator = RopeSimulator::new(10);
    longer_simulator.simulate_from_file("resources/input_1");
    let solution_2 = longer_simulator.num_spaces_tail_visited();
